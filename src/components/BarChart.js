...
var global_data = {};
var chartReference = {};
var city =["Bangalore","Chennai","Delhi","Kolkata","Mumbai","Surat","Indore","Ahmedabad","Pune","Hyderabad"];
var plot_data =[];
const BarChart = () => {
  ...
  return (
    ...
    <div className="BarChart">
      ...
      <div style={{ maxWidth: "650px" }} >
        <Bar
          data={{
            labels: ["Mumbai","Bangalore","Chennai","Delhi","Kolkata","Surat","Indore","Ahmedabad","Pune","Hyderabad"],
            datasets: [
              {
                label: "AQV",
                data: plot_data,
